...
/**
 * Class LeagueHistoryPitchingStat
 * 
 ...
 * @property int|null $ir
 * @property int|null $irs
 ...
 * @package App\Models
 */
class LeagueHistoryPitchingStat extends Model
{
	protected $table = 'league_history_pitching_stats';
