 ...
 * @property int|null $player_payroll
 * @property int|null $player_payroll_next_season
 * @property int|null $player_payroll_offered
 * @property int|null $mode
 * @property int|null $cash_trades_available
 *
 * @package App\Models
 */
class TeamFinancial extends Model
{
	protected $table = 'team_financials';
	...
	protected $fillable = [
		...
		'budget_balance',
		'player_payroll',
		'player_payroll_next_season',
		'player_payroll_offered',
		'mode',
